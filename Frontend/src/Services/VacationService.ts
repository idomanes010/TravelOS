...
//     public async getVacationsById(vacationId: number): Promise<VacationModel> {
...
//         await axios.post<VacationModel>(appConfig.adminAddVacationUrl, myFormData);
...
//         await axios.post<VacationModel>(appConfig.adminUpdateVacationUrl + vacation.vacationId, myFormData);
//     }
